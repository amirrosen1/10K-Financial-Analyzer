...
# Full list of formatted questions (index = question number - 1)
QUESTIONS = [
    "What was the company’s operating income in [year]?",
    "What was the company’s gross profit in [year]?",
    "What was the company's earnings per share (EPS) in [year]?",
    "What was the company’s cash flow from operating activities in [year]?",
    "What were the company’s capital expenditures in [year]?",
    "What was the company's total liabilities in [year]?",
    "What were the company's total assets in [year]?",
    "Did the company issue or repurchase stock in [year]?",
    "How much did the company spend on marketing or sales in [year]?",
    ...
    "How has [Company]'s net income changed over the last 5 years?",
    "What is the year-over-year growth rate in revenue for [Company]?",
    ...
    "Is [Company]’s revenue growth rate above or below the industry average over the past 3 years?",
    ...
    "How has [Company]'s efficiency changed over time in converting assets into revenue (Asset Turnover Ratio)?",
    ...
    "What will be [Company]’s projected net income for next year(s)?",
    "Predict which companies are likely to report a decline in net income next year.",
    "When is [Company] likely to surpass $X in annual revenue?",
...
def run_all_insights():
    ...
    for i in range(1, 61):
        ...
        # Prepare readable question
        question_template = QUESTIONS[i - 1]
        question = question_template.replace("[Company]", company).replace("[year]", str(year)).replace("the company", company)
